...
export default async function BudgetPage() {
  ...
  const budgets = await db.budget.findMany({ where: { year: 2026 }, include: { subsidiary: true }, orderBy: { subsidiary: { sortOrder: "asc" } } });
  const monthly = await db.monthlyFinancial.findMany({ where: { year: 2026 } });
